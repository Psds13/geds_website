  ...
  return (
    <section className="max-w-7xl mx-auto py-24 px-6 bg-background relative transition-colors">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 relative">
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-16 h-16 bg-background border border-foreground/10 rounded-full hidden md:flex items-center justify-center text-cyan-600 dark:text-cyan-400 z-10 shadow-xl group-hover:rotate-180 transition-transform duration-1000 scale-105">
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className="bg-red-50/50 dark:bg-[#0a0000] border border-red-500/10 rounded-4xl p-10 hover:bg-red-100/50 dark:hover:bg-red-950/20 transition-all duration-500 shadow-xl group flex flex-col"
        >
          <div className="flex items-center gap-4 mb-8 border-b border-red-500/10 pb-6 shrink-0">
            ...
            <h3 className="text-xl font-bold text-foreground tracking-tight uppercase italic">Passado Ineficiente</h3>
          </div>
          <ul className="space-y-6">
            {[
              ...
              <li key={i} className="flex items-start gap-4 text-foreground/90 text-sm leading-relaxed font-bold tracking-tight">
                <FiX className="text-red-500 shrink-0 mt-0.5 w-5 h-5 shadow-[0_0_10px_rgba(239,68,68,0.3)]" />
        ...
        <motion.div
          ...
          className="bg-emerald-50/50 dark:bg-[#000a05] border border-emerald-500/10 rounded-4xl p-10 hover:bg-emerald-100/50 dark:hover:bg-emerald-950/20 transition-all duration-500 shadow-xl flex flex-col group"
        >
