...
export default function Footer() {
  ...
  return (
    <footer className="bg-black text-white pt-20 pb-10 border-t border-cyan/10 relative overflow-hidden">
      {/* Decorative Glow */}
      <div className="absolute top-0 right-0 w-[300px] h-[300px] bg-cyan/5 rounded-full blur-[100px] -z-10"></div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-gray-400 mb-8 max-w-md leading-relaxed">
              Desenvolvemos o futuro do seu negócio através de soluções tecnológicas disruptivas,
              focadas em UX design e performance de alto nível.
            </p>
            <div className="flex space-x-5">
              {[
                ...
                <a key={social.name} href="#" className={`w-10 h-10 rounded-full bg-white/5 flex items-center justify-center text-gray-500 hover:text-white transition-all duration-300 transform hover:-translate-y-1 ${social.color}`}>
          ...
          {/* Contato */}
          <div>
            <h3 className="text-white font-black uppercase tracking-widest text-sm mb-6">Contato</h3>
            <ul className="space-y-4">
              <li className="flex items-start group">
                <div className="p-2 rounded-lg bg-cyan/10 text-cyan mr-3 transition-colors group-hover:bg-cyan group-hover:text-black">
                  <svg className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                  </svg>
                </div>
                <span className="text-gray-400 text-sm group-hover:text-white transition-colors">contato@gedsinovacao.com</span>
              </li>
              <li className="flex items-start group">
                <div className="p-2 rounded-lg bg-cyan/10 text-cyan mr-3 transition-colors group-hover:bg-cyan group-hover:text-black">
                  <svg className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <span className="text-gray-400 text-sm group-hover:text-white transition-colors">+55 (98) 99999-9999</span>
              </li>
              <li className="flex items-start group">
                <div className="p-2 rounded-lg bg-cyan/10 text-cyan mr-3 transition-colors group-hover:bg-cyan group-hover:text-black">
                  <svg className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <span className="text-gray-400 text-sm group-hover:text-white transition-colors">São Luís - MA, Brasil</span>
              </li>
            </ul>
          </div>
        </div>
