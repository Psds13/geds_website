          ...
          <div className="lg:col-span-2">
            ...
            <div className="flex space-x-5">
              {[
                ...
                <a key={social.name} href="#" className="w-10 h-10 rounded-full bg-cyan/10 flex items-center justify-center text-cyan hover:bg-cyan hover:text-black transition-all duration-300 transform hover:-translate-y-1">
